//! Kaorust is a Hierarchical State Machine (HSM) framework developed in Rust at destination of both embedded system and desktop computers.
//! The framwork has the advantages of being free of dynamic allocation and of virtual table.
...
//! which will be called at the initialization of the machine and setting the first state.
